...
return [
    ...
    */
    ...
    'caricamento_interrotto' => 'O carregamento parou antes de terminar, e não por causa do tamanho do ficheiro. Normalmente é o disco do servidor cheio, uma pasta temporária sem permissão de escrita ou a ligação caída a meio. Tente de novo; se repetir, o problema está no servidor.',
    'corpo_troppo_grande' => 'O ficheiro que está a carregar excede o limite global deste servidor (:limite): o pedido foi descartado antes de chegar à aplicação, e por isso pode parecer uma sessão expirada. Peça a quem gere o servidor para aumentar post_max_size (além de upload_max_filesize), ou carregue um ficheiro mais pequeno.',
    'uploaded' => 'Não foi possível carregar :attribute: o ficheiro excede o limite deste servidor (:limite). Peça a quem o gere para aumentar upload_max_filesize e post_max_size, ou carregue um ficheiro mais pequeno.',
