...
return [
    ...
    */
    ...
    | definir rapidamente uma mensagem personalizada para uma regra específica.
    |
    */
    'custom' => [
        'email' => [
    ...
    */
    'attributes' => [
        ...
        'comunicacoes' => [
            ...
            'is_published' => 'estado',
            'priority' => 'prioridade',
            'stado' => 'estado das comunicações',
            'condominios_ids' => 'condomínios',
        ],
        'sinalizacoes' => [
        ...
        'eventos' => [
            ...
            'categoria_id' => 'categoria',
            'recorrencia_ate' => 'data de fim da recorrência',
            'condominios_ids' => 'condomínios',
            'visibilidade' => 'estado de publicação',
        ],
        'palazzine' => [
