...
return [
    ...
    /* ------------------------------------------------------------------
     ...
     | ------------------------------------------------------------------ */
    'driver' => [
        'smtp_description'     => 'Servidor SMTP externo (Gmail, Brevo, etc.)',
        'sendmail_description' => 'Mail PHP local — ideal para alojamentos partilhados',
    ],
    ...
    'header' => [
        ...
        'mail_settings_description'    => 'Configure o método de envio para recibos, avisos e comunicações oficiais.',
    ],
    ...
    'dialogs' => [
        ...
        'mail_guide_title'                      => 'Guia de configuração SMTP',
        'mail_guide_gmail'                      => 'Gmail: Ative a verificação em 2 passos e gere uma "Palavra-passe de aplicação". Use a porta 587 com TLS.',
        'mail_guide_smtp2go'                    => 'Servidores Gratuitos: Se usa o Altervista, considere o Sendmail ou o SMTP2Go para contornar bloqueios de portas.',
        'mail_guide_domain'                     => 'Dica Pro: Use um domínio profissional validado para evitar que os emails vão para o spam.',
        'mail_info_title'                       => 'Como funciona o envio de emails?',
        'mail_info_description'                 => 'O Kondomanager suporta dois métodos de envio: <strong>SMTP</strong> para servidores externos (Gmail, Brevo, etc.) e <strong>Sendmail</strong> para alojamentos partilhados (ex: Altervista) onde as portas SMTP estão bloqueadas.<br><br>Se desativar a configuração da base de dados, será usada a do ficheiro <strong>.env</strong>.',
        ...
        'sendmail_guide_title'                  => 'Sendmail — nenhuma credencial necessária',
        'sendmail_guide_description'            => 'Os emails são enviados através do servidor de correio local (PHP mail). Ideal para alojamentos partilhados como o Altervista onde as portas SMTP externas estão bloqueadas. A entregabilidade depende da reputação do servidor.',
