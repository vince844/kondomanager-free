...
import DataTableToolbar from '@/components/gestionale/palazzine/DataTableToolbar.vue';
...
const props = defineProps<{
  columns: ColumnDef<Palazzina, any>[],
  data: Palazzina[],
  condominio: Building 
  meta: {
    current_page: number,
...
const { inCorso, ordinamento, suPaginazione, suOrdinamento } =
  useTabellaServer(() => route(generateRoute('gestionale.palazzine.index'), { condominio: props.condominio.id}));
