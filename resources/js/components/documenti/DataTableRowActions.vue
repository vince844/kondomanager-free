    ...
    <AlertDialogContent>
      <AlertDialogHeader>
        ...
        <AlertDialogDescription>
          Questa azione non è reversibile. Eliminerà il documento e tutti i dati ad essa associati.
        </AlertDialogDescription>
      </AlertDialogHeader>
      <AlertDialogFooter>
        <AlertDialogCancel @click="isAlertOpen = false">Cancella</AlertDialogCancel>
        <AlertDialogAction  @click="deleteDocumento()">Continua</AlertDialogAction>
      </AlertDialogFooter>
    </AlertDialogContent>
  </AlertDialog>
</template>