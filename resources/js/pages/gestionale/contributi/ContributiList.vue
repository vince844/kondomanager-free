...
import { Wallet, Search, ArrowRight, CheckCircle2, Circle, ListFilter, Scale } from 'lucide-vue-next';
...
const guide = [
  ...
  {
    title: 'Quali voci vedi qui',
    description: 'Solo le voci marcate "da esercizio precedente" al momento della creazione. Non trovi quella che cerchi? Aprila nel piano dei conti e attiva l\'opzione.',
    icon: ListFilter,
    colorVariant: 'blue' as const,
  },
  {
    title: 'Effetto sul riparto',
    description: 'Una volta registrato il già versato, il piano rate per quella voce chiede automaticamente solo il residuo — nessun ricalcolo manuale.',
    icon: Scale,
      ...
      <div class="w-full">
        <StrutturaLayout>
          ...
          <div class="container mx-auto p-0 mt-4 space-y-4">
            ...
            <div class="bg-white border rounded-2xl overflow-hidden overflow-x-auto">
