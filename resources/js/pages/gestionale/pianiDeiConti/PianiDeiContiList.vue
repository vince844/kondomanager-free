...
import { getColumns } from '@/components/gestionale/pianiDeiConti/columns';
      ...
      <div class="w-full shadow ring-1 ring-black/5 md:rounded-lg p-4">
        <section class="w-full">
          ...
          <div class="container mx-auto p-0">
            <DataTable :columns="columns" :data="props.pianiDeiConti" :meta="props.meta" :condominio="props.condominio"/>
          </div>
