    ...
    @if ($isMailRequired)
        ...
        <div class="grid grid-cols-2 gap-4 mt-6">
            <div>
                ...
                <input type="text" name="mail-mailer" id="mail-mailer" placeholder="smtp" wire:model.blur="mailMailer">
                @error('mailMailer')
            ...
            <div>
                ...
                <x-installer.password-input id="mail-password" name="mail-password" wire:model.blur="mailPassword" />
                @error('mailPassword')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="col-span-full">
                ...
                <input type="text" name="mail-from-address" id="mail-from-address" placeholder="amministrazione@dominio.com" wire:model.blur="mailFromAddress">
            ...
            <div class="col-span-full">
                ...
                <input type="text" name="mail-from-name" id="mail-from-name" placeholder="Amministrazione" wire:model.blur="mailFromName">
                @error('mailFromName')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
