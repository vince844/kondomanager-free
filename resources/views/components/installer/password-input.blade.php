...
<div x-data="{ show: false }" class="relative">
    <input type="password" :type="show ? 'text' : 'password'" id="{{ $id }}" {{ $attributes->merge(['class' => 'pe-10']) }}>
    ...
    <button
        ...
        :aria-label="show ? '{{ __('installer.actions.hide_password') }}' : '{{ __('installer.actions.show_password') }}'"
    >
