...
> **Stato:** Non implementato — verificato il 31/07/2026 su 1.10.0-beta.32
> Le decisioni di design (§13) e i criteri del duplicate detector restano validi come base di lavoro; niente di questa maschera esiste nel codice e la mappatura di release (v1.9.2 / v1.9.6 / v1.13) è superata.
<!-- /verifica-documentazione -->
...
<!-- rettifica -->
> ⚠️ **Non è più vero — verificato il 31/07/2026 su 1.10.0-beta.32.** Nessun file con quel nome esiste in docs/. Il documento sul tema è `docs/scoperto-quote-senza-destinatario.md`; in docs/ non esiste alcun file con prefisso `adr-`.
> *Prova:* ls docs/ (48 file) = nessun `adr-scoperto-quote-orfane.md`; l'unico documento su quote senza destinatario è docs/scoperto-quote-senza-destinatario.md.
<!-- /rettifica -->
