...
> **Stato:** Superato — verificato il 31/07/2026 su 1.10.0-beta.32
> È una copia più vecchia e incompleta di `guida_preventivi_rate_capitoli.md`, che lo contiene integralmente e in più documenta la selezione del tipo di piano, il monitoraggio da dashboard e i dettagli UI delle sopravvenienze.
> Da archiviare: usare `guida_preventivi_rate_capitoli.md`.
<!-- /verifica-documentazione -->
