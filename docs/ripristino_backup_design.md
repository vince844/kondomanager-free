...
> **Stato:** Descrive il codice — verificato il 31/07/2026 su 1.10.0-beta.32
> M1 (ripristino dal pannello) è implementato come descritto e puoi fidarti di architettura, fasi e scelte; M2 (ramo del wizard) e il §14 (upload archivio esterno, fingerprint di installazione) sono ancora spec non costruite, non codice esistente.
<!-- /verifica-documentazione -->
